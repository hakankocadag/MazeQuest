...
public class MazePanel extends JPanel {
    ...
    public boolean moveForward() {
        ...
        if (playerDirection == 0 && !currentCell.wallN) { newR--; } 
        else if (playerDirection == 1 && !currentCell.wallE) { newC++; } 
        else if (playerDirection == 2 && !currentCell.wallS) { newR++; } 
        else if (playerDirection == 3 && !currentCell.wallW) { newC--; } 
        else { return false; }
